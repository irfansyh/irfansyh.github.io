...
<img src="{{ '/assets/img/distro-linux/mint.png' | prepend: site.baseurl }}" alt="Linux Mint">
...
<img src="{{ '/assets/img/distro-linux/elementary.png' | prepend: site.baseurl }}" alt="Elementary OS">
...
<img src="{{ '/assets/img/distro-linux/ubuntu.jpg' | prepend: site.baseurl }}" alt="Ubuntu">
...
<img src="{{ '/assets/img/distro-linux/zorinos.jpg' | prepend: site.baseurl }}" alt="Zorin OS">
